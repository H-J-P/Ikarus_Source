...
{
    /// <summary>
    /// Interaction logic for UH1_OilTTrans.xaml
    /// </summary>
    public partial class UH1_OilTTrans : UserControl, I_Ikarus
    {
                       ...
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               if (lneedle != needle)
                               {
                                   ...
                                   TransmOilTemp.RenderTransform = rtrNeedle;
                               }
                               lneedle = needle;
                           }
                           catch { return; }
