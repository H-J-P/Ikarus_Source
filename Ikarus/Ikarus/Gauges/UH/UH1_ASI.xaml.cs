...
{
    /// <summary>
    /// Interaction logic for UH1_ASI.xaml
    /// </summary>
    public partial class UH1_ASI : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           ...
                           try
                           {
                               ...
                               if (vals.Length > 0) { airSpeedNose = Convert.ToDouble(vals[0], CultureInfo.InvariantCulture); }
                               if (vals.Length > 1) { airSpeedRoof = Convert.ToDouble(vals[1], CultureInfo.InvariantCulture); }
