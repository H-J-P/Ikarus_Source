...
{
    /// <summary>
    /// Interaction logic for WPASI16.xaml
    /// </summary>
    public partial class WPASI16 : UserControl, I_Ikarus
    {
        ...
        public WPASI16()
        {
            ...
            Disk.Visibility = System.Windows.Visibility.Hidden;
        }
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               if (lmach != mach || lias != ias)
                               {
                                   rtMach.Angle = (mach * -330) + (ias * 333);
                                   Mach.RenderTransform = rtMach;
                               }
                               //Disk.Visibility = mach > 0.4 ? System.Windows.Visibility.Hidden : System.Windows.Visibility.Visible;
