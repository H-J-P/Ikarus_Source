...
{
    /// <summary>
    /// Interaction logic for L39_Brake.xaml
    /// </summary>
    public partial class L39_Brake : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               if (vals.Length > 0) { brake = Convert.ToDouble(vals[0], CultureInfo.InvariantCulture); }
