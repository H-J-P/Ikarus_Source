...
{
    /// <summary>
    /// Interaction logic for Spit_OilP.xaml
    /// </summary>
    public partial class Spit_OilP : UserControl, I_Ikarus
    {
                       ...
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               if (lpointer != pointer)
                               {
                                   ...
                                   {
                                       Cockpit.UpdateInOut(dataImportID, "1", pointer.ToString(), Convert.ToInt32(ttpointer.Y).ToString());
                                   }
