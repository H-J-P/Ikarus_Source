...
{
	/// <summary>
	/// Interaction logic for Spit_OxyP.xaml
	/// </summary>
	public partial class Spit_OxyP : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               // input  {0.0, 0.10, 0.15, 0.20, 0.25, 0.30,  0.35, 1.0}
                               // output {  0,   10,   15,   20,   25,   30, 35/40, Ende}
                               // °      {  0,   30,   68,   89,  129,  166,  184, 301}
                               ...
                               if (lpointer != pointer)
                               {
                                   ...
                                   Oxy_P.RenderTransform = rtpointer;
                               }
                               lpointer = pointer;
                           }
                           catch { return; }
