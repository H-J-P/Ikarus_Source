...
{
    /// <summary>
    /// Interaction logic for MIG21_OilPressure.xaml
    /// </summary>
    public partial class MIG21_OilPressure : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               {
                                   rtoilPressure.Angle = oilPressure * 80;
