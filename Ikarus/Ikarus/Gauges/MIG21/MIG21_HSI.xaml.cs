...
namespace Ikarus
{
    ...
    /// </summary>
    public partial class MIG21_HSI : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               {
                                   rtRequiredHeading.Angle = requiredHeading * 360;
                                   RequiredHeading.RenderTransform = rtRequiredHeading;
                               }
                               if (lbearingNeedle != bearingNeedle)
                               {
                                   rtBearingNeedle.Angle = (bearingNeedle * 360) + 180;
                                   BearingPointer.RenderTransform = rtBearingNeedle;
                               }
