...
{
    /// <summary>
    /// Interaction logic for MIG15_RadioCompass.xaml
    /// </summary>
    public partial class MIG15_RadioCompass : UserControl, I_Ikarus
    {
                       ...
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               if (lbearing != bearing)
                               {
                                   ...
                                   ARC5_Bearing.RenderTransform = rtBearing;
                               }
                               lbearing = bearing;
                           }
                           catch { return; }
