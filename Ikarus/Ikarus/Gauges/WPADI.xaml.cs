...
namespace Ikarus
{
    ...
    public partial class WPADI : UserControl, I_Ikarus
    {
        ...
        double pitch = 0.0;
        double sideslip = 0.0;
        double steeringWarningFlag = 0.0; // Flag_L
        double attitudeWarningFlag = 0.0; // Flag_R
        ...
        double lsteeringWarningFlag = 0.0; // Flag_L
        double lattitudeWarningFlag = 0.0; // Flag_R
