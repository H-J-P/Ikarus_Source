...
{
    /// <summary>
    /// Interaction logic for F86_CabinP.xaml
    /// </summary>
    public partial class F86_CabinP : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               {
                                   rtPressure.Angle = pressure * 300;
                                   CockpitAltimeter.RenderTransform = rtPressure;
                               }
                               lpressure = pressure;
                           }
                           catch { return; }
