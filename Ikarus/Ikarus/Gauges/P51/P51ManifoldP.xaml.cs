...
{
    /// <summary>
    /// Interaction logic for P51ManifoldP.xaml
    /// </summary>
    public partial class P51ManifoldP : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               {
                                   rtManifoldPressure.Angle = manifoldPressure * 345;
                                   Manifold_Pressure.RenderTransform = rtManifoldPressure;
                               }
