...
{
    /// <summary>
    /// Interaction logic for A10_OilP.xaml
    /// </summary>
    public partial class A10_OilP : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               {
                                   rtoilPressure.Angle = oilPressure * 270;
                                   EngineOilPressure.RenderTransform = rtoilPressure;
                               }
