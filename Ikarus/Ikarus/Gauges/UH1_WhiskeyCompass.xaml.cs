...
namespace Ikarus
{
    ...
    /// </summary>
    public partial class UH1_WhiskeyCompass : UserControl, I_Ikarus
    {
        ...
        public UH1_WhiskeyCompass()
        {
            InitializeComponent();

            if (MainWindow.editmode) MakeDraggable(this, this);

            Heading.Visibility = System.Windows.Visibility.Hidden;
        }
