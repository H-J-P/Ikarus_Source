...
{
    /// <summary>
    /// Interaction logic for ME4KGear.xaml
    /// </summary>
    public partial class BfK4Gear : UserControl, I_Ikarus
    {
        ...
        public BfK4Gear()
        {
            ...
            GEAR_UP.Visibility = System.Windows.Visibility.Hidden;
        }
        ...
        public void UpdateGauge(string strData)
        {
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           ...
                           try
                           {
                               if (vals.Length > 0) { gearUp = Convert.ToDouble(vals[0], CultureInfo.InvariantCulture); }
                               if (vals.Length > 1) { leftGearDown = Convert.ToDouble(vals[1], CultureInfo.InvariantCulture); }
                               if (vals.Length > 2) { rightGearDown = Convert.ToDouble(vals[2], CultureInfo.InvariantCulture); }                                   
                           }
                           catch { return; }
                           ...
                           GEAR_UP.Visibility = (gearUp > 0.8) ? System.Windows.Visibility.Visible : System.Windows.Visibility.Hidden;
                       }));
        }
