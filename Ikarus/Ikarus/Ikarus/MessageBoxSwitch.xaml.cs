        ...
        private void ChangeSourceDatagridSwitches()
        {
            if (MainWindow.dtMasterSwitches != null)
            {
                ...
                if (setSwitch)
                {
                    ...
                    {
                        if (Classname.Text == "Button" || Classname.Text == "ButtonWithRepeat" )
                        {
                            Input.Text = "1.0";
                            Output.Text = "1.0";
                        }
                        ...
                        if (Classname.Text == "SwitchOnOffOn")
                        {
                            Input.Text = "-1.0,0.0,1.0";
                            Output.Text = "-1.0,0.0,1.0";
                        }

                        if (Classname.Text == "Switch_OnOFFOn")
                        {
                            Input.Text = "(-1.0),0.0,(1.0)";
                            Output.Text = "(-1.0),0.0,(1.0)";
                        }

                        if (Classname.Text == "Switch_OFFOn")
                        {
                            Input.Text = "0.0,(1.0)";
                            Output.Text = "0.0,(1.0)";
                        }

                        //if (Classname.Text == "ButtonOffOn")
                        //{
                        //    Input.Text = "";
                        //    Output.Text = "";
                        //}
