...
namespace Ikarus
{
    ...
    /// </summary>
    public partial class F5E_TacanDisplay : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               Pos1000.Text = valueInt1000.ToString();
                               Pos100.Text = valueInt100.ToString();
                               Pos10.Text = valueInt10.ToString();
                               Pos1.Text = value1 == 0.0 ? "X" : "Y";
                           }
                           catch { return; }
                       }));
        }
