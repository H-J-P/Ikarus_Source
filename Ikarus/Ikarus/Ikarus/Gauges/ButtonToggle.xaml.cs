...
namespace Ikarus
{
    ...
    /// </summary>
    public partial class ButtonToggle : UserControl, I_Ikarus
    {
        ...
        public void UpdateGauge(string strData)
        {
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           ...
                           if (switchState > 0.0) { SetValue(1.0, false); }
        ...
        private void SetValue(double _value, bool _event, bool dontReset = false)
        {
            try
            {
                ...
                if (switches != null)
                {
                    ...
                    if (_event) switches.oldValue = -1.0;

                    switchState = _value;
                    switches.events = _event;
                    switches.dontReset = false;
                    //switches.sendRelease = true;
                }
        ...
        {
            if (switchState == 0.0) SetValue(1.0, true);
            else { SetValue(0.0, true); }
