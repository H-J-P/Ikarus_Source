...
{
    public partial class A10IASGauge : UserControl, IHawgTouchGauge
    {
        ...
        public A10IASGauge(/*string strDataImportID*/)
        {
            InitializeComponent();
        ...
        public void UpdateGauge(string strData)
        {
            ...
            this.Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           ...
                           rt.Angle = angle * 360 - 15;
                           this.AirspeedNeedle.RenderTransform = rt;
                       }));
        }
    }
}
