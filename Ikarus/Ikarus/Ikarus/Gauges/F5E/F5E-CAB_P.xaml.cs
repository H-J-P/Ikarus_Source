...
{
    /// <summary>
    /// Interaction logic for F5E_CAB_P.xaml
    /// </summary>
    public partial class F5E_CAB_P : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               {
                                   rtPressure.Angle = pressure * 248;
                                   Cabin_P.RenderTransform = rtPressure;
                               }
                               lpressure = pressure;
                           }
                           catch { return; }
