...
{
    /// <summary>
    /// Interaction logic for A10_RPMFAN.xaml
    /// </summary>
    public partial class A10_RPMFAN_V1 : UserControl, I_Ikarus
    {
        ...
        RotateTransform rtfanRPM = new RotateTransform();

        public A10_RPMFAN_V1()
        {
            InitializeComponent();
                       ...
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               if (lfanRPM != fanRPM)
                               {
                                   ...
                                   {
                                       if (fanRPM >= valueScale[n] && fanRPM <= valueScale[n + 1])
                                       {
