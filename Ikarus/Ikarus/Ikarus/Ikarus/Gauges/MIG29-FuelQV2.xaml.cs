...

{
    ...
    /// </summary>
    public partial class MIG29_FuelQV2 : UserControl, I_Ikarus
    {
            ...
            Dispatcher.BeginInvoke(DispatcherPriority.Normal,
                       (Action)(() =>
                       {
                           try
                           {
                               ...
                               if (vals.Length > 1) { totalFuel_5_7_5 = Convert.ToDouble(vals[1], CultureInfo.InvariantCulture); }
                               if (vals.Length > 2) { totalFuel = Convert.ToDouble(vals[2], CultureInfo.InvariantCulture); }
                               ...
                               TotalFuelLong.Height = totalFuel_0_5 * 189;
                               TotalFuelShort.Height = totalFuel_5_7_5 * 78;
